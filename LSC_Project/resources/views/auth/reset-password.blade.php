...
<head>
    ...
    <title>Reset Kata Sandi — Lose ShoesCare</title>
    <meta name="description" content="Buat kata sandi baru untuk akun Lose ShoesCare kamu.">
...
<main style="flex:1; display:flex; align-items:center; justify-content:center; padding: 3rem 1rem;">
    <div style="display:grid; grid-template-columns:1fr 1fr; max-width:960px; width:100%; border:3px solid #000; box-shadow: 8px 8px 0px 0px #000; overflow:hidden; background:#fff;">
        ...
        {{-- Left: Brand panel --}}
        <div style="background:#0058be; padding:3rem; display:flex; flex-direction:column; justify-content:space-between; min-height:520px;">
            <div>
                ...
                <h1 style="font-family:'Space Grotesk',sans-serif; font-weight:900; font-size:2.4rem; text-transform:uppercase; color:#fff; line-height:1; margin-bottom:1.5rem;">
                    BUAT<br>KATA<br><span style="color:#fed01b;">SANDI<br>BARU.</span>
                </h1>
                <p style="color:rgba(255,255,255,0.75); font-size:0.9rem; line-height:1.6;">
                    Masukkan kata sandi baru yang kuat untuk mengamankan akunmu. Pastikan minimal 8 karakter.
                </p>
            </div>
            {{-- Bottom tips --}}
            <div style="display:flex; flex-direction:column; gap:12px; margin-top:2rem;">
                @foreach(['Minimal 8 karakter', 'Gunakan kombinasi huruf & angka', 'Jangan bagikan ke siapapun'] as $tip)
                    <div style="display:flex; align-items:center; gap:10px; color:#fff;">
                        ...
                        <span style="font-size:0.9rem; font-weight:600;">{{ $tip }}</span>
                    </div>
                @endforeach
            </div>
        </div>
        ...
        <div style="padding:3rem; background:#fff; display:flex; flex-direction:column; justify-content:center;">
            <h2 style="font-family:'Space Grotesk',sans-serif; font-weight:900; font-size:1.8rem; text-transform:uppercase; color:#191b23; margin-bottom:0.5rem;">Reset Kata Sandi</h2>
            <p style="color:#6b7280; font-size:0.9rem; margin-bottom:2rem;">Buat kata sandi baru untuk akunmu.</p>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                {{-- New Password --}}
                <div style="margin-bottom:1.25rem;">
                    <label for="password" style="display:block; font-family:'Space Grotesk',sans-serif; font-weight:700; font-size:0.75rem; text-transform:uppercase; letter-spacing:.05em; color:#191b23; margin-bottom:6px;">Kata Sandi Baru</label>
                    <div style="position:relative;">
                        ...
                        <button type="button" onclick="togglePass('password', this)"
                                style="position:absolute; right:12px; top:50%; transform:translateY(-50%); background:none; border:none; cursor:pointer; padding:0; color:#6b7280;">
                ...
                <div style="margin-bottom:1.75rem;">
                    <label for="password_confirmation" style="display:block; font-family:'Space Grotesk',sans-serif; font-weight:700; font-size:0.75rem; text-transform:uppercase; letter-spacing:.05em; color:#191b23; margin-bottom:6px;">Konfirmasi Kata Sandi</label>
                    <div style="position:relative;">
